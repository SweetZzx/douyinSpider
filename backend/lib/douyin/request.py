...
from backend.lib.douyin.types import (
    APIEndpoint,
    CookieField,
    DouyinURL,
    RequestHeaders,
...
from backend.lib.douyin.abogus import ABogus
...
class Request(object):
    ...
    用于处理抖音网页端的HTTP请求，包括签名生成、参数构建等功能
    使用纯Python实现的a_bogus签名算法，无需exejs依赖
    """

    HOST = DouyinURL.BASE
    # a_bogus 签名器（纯Python实现）
    ABOGUS = ABogus()
